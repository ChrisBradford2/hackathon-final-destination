...
from app import db
from app.models.Audio import Audio  # Utiliser le chemin complet de l'importation
...
def upload_file(file, bucket_name, s3_file):
    ...
    try:
        ...
        new_audio = Audio(audio=file.filename, file_upload_id=new_upload.id, filename=file.filename, bucket_name=bucket_name, s3_key=s3_file)
